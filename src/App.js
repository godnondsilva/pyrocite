...
class App extends React.Component {
  ...
  await web3.eth.getAccounts(function (err, accounts) {
    ...
    window.onload = (async () => {
      ...
      var account = web3.eth.personal.defaultAccount;
      contract.methods.balanceOf(account).call({ from: account}).then(function(e){
        if (e) {
      ...
      contract.methods.frozenOf(account).call({from:account}).then(function(e){
        if(e){
      ...
      contract.methods.totalFrozen().call({from:account}).then(function(e){
        if(e){
          var totalFrozen = e/1000000;
          totalFrozen = totalFrozen/1000000;
          totalFrozen = totalFrozen/1000000;
      ...
      contract.methods.totalSupply().call({from:account}).then(function(e){
        if(e){
          var totalFrozen = e/1000000;
          totalFrozen = totalFrozen/1000000;
          totalFrozen = totalFrozen/1000000;
    ...
    return (
      <div>
        <Router>
          <Switch>
            <Route path="/" exact>
              <Header loadWeb3={this.loadWeb3} />
              <Home />
              <Footer />
            </Route>
            <Route path="/wallet">
              <Header loadWeb3={this.loadWeb3} />
              <Wallet loadWeb3={this.loadWeb3} />
              <Footer />
            </Route>
          </Switch>
        </Router>
